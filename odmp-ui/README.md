...
* [`src/clj/tdmp_ui/`](src/clj/tdmp_ui/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/tdmp_ui/`](src/cljs/tdmp_ui/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/tdmp_ui/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `tdmp-ui` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/tdmp_ui/config.cljs) defaults to `true` in
...
```clj
(ns tdmp-ui.example
  (:require [tdmp-ui.config :as config])
